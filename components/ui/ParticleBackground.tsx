...
export const ParticlesBackground: FC<Props> = (props) => {
  ...
  const options = useMemo(() => {
    ...
    return {
      ...
      particles: {
        ...
        opacity: {
          value: 1, // using a different opacity, to have some semitransparent effects
        },
        size: {
          value: 0.001, // let's randomize the particles size a bit
        },
        number: {
          value: 50,
        },
